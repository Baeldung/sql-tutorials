...
-- 4. Insert numeric equivalents
INSERT INTO Users VALUES (3, 'Alex', 'IT', 1);
INSERT INTO Users VALUES (4, 'Jane', 'Finance', 0);
SELECT * FROM Users WHERE is_active = 1;

-- 5. Use TINYINT(1) explicitly
ALTER TABLE Users
...
-- 7. Use ENUM for custom Boolean-like values
ALTER TABLE Users
